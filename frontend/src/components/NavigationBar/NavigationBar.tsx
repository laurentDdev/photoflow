        ...
        <header className={styles.navigationBar}>
            <div className={"d-flex flex-column align-items-center"}>
                <div className={styles.headerInfos}>
                    <img height={50} src={`http://localhost:3000/assets/avatars/${user.avatar}.png`} alt=""/>
                    <h3>{user.username}</h3>
                    <span
                ...
                <div className={`${styles.stats}`}>
                    ...
                    <div className={"d-flex flex-column align-items-center"}>3.5k <span>Followers</span></div>
                ...
                <div className={`${styles.navigation}`}>
                    <ul>
                        ...
                        <li><NavLink to={"fav"} className={({isActive}) => isActive ? styles.navActive : ""}><i
                            className={"fa-solid fa-star"}></i>Favoris</NavLink></li>
                        <li><NavLink to={"profile"} className={({isActive}) => isActive ? styles.navActive : ""}><i
                            className={"fa-solid fa-user"}></i>Profil</NavLink></li>
                        <li><NavLink to={"settings"} className={({isActive}) => isActive ? styles.navActive : ""}><i
            ...
            <div className={styles.logout}>
                <button onClick={logout}><i className={"fa-solid fa-right-from-bracket"}></i>Se déconnecter</button>
            </div>
        </header>
    );
};
